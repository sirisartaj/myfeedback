...
<head>
		...
		<!-- FAVICON -->
		<link rel="shortcut icon" type="image/x-icon" href="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo-2.png"/>

		<!-- TITLE -->
		<title>Riding Solo </title>

		<!-- BOOTSTRAP CSS -->
		<link id="style" href="https://vyz.bz/ridingsolo_admin/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />

		<!-- STYLE CSS -->
		<link href="https://vyz.bz/ridingsolo_admin/assets/css/style.css" rel="stylesheet" />
		<link href="https://vyz.bz/ridingsolo_admin/assets/css/skin-modes.css" rel="stylesheet" />
	...
	<body class="ltr app sidebar-mini light-mode">
		...
		<div id="global-loader">
			<img src="https://vyz.bz/ridingsolo_admin/assets/images/loader.svg" class="loader-img" alt="Loader">
		</div>
		<!-- /GLOBAL-LOADER -->
			...
			<div class="page-main">
				...
				<div class="app-header header sticky">
					<div class="container-fluid main-container">
						<div class="d-flex">
							<a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar" href="https://vyz.bz/ridingsolo_admin/#"></a>
							<!-- sidebar-toggle-->
							<a class="logo-horizontal " href="https://vyz.bz/ridingsolo_admin/index.php">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo.png" class="header-brand-img light-logo1"
									alt="logo">
							</a>
							<!-- LOGO -->
							...
							<div class="d-flex order-lg-2 ms-auto header-right-icons">
								<div class="dropdown d-xl-none d-md-block d-none">
									<a href="https://vyz.bz/ridingsolo_admin/#" class="nav-link icon" data-bs-toggle="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													<div class="drop-heading border-bottom">
														<div class="d-flex">
															...
															<div class="ms-auto">
																<span class="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a href="https://vyz.bz/ridingsolo_admin/javascript:void(0);" class="showall-text text-white">Clear</a> </span>
															</div>
														</div>
													</div>
													<div class="notifications-menu ps3 overflow-hidden">
														<a class="dropdown-item" href="https://vyz.bz/ridingsolo_admin/#">
											...
											<div class="dropdown d-md-flex profile-1">
												<a href="https://vyz.bz/ridingsolo_admin/#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
													...
													<div class="text-center p-1 d-flex d-lg-none-max">
														<h6 class="mb-0 ms-1" id="profile-heading">Harish Nammi<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
													</div>
												</a>
												<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													<a class="dropdown-item" href="https://vyz.bz/ridingsolo_admin/#">
													...
													<a class="dropdown-item" href="https://vyz.bz/ridingsolo_admin/change-password.php">
													...
													<a class="dropdown-item" href="https://vyz.bz/ridingsolo_admin/index.php">
				...
				<div class="sticky">
					...
					<div class="app-sidebar">
						<div class="side-header">
							<a class="header-brand1" href="https://vyz.bz/ridingsolo_admin/index.php">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo.png" class="header-brand-img toggle-logo" alt="logo">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
								<img src="https://vyz.bz/ridingsolo_admin/assets/images/brand/logo.png" class="header-brand-img light-logo1" alt="logo">
							</a><!-- LOGO -->
						</div>
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/dashboard.php">
										<i class="fe fe-home"></i> <span class="side-menu__label">Dashboard</span>
									</a>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/upcoming_trips.php">
										<i class="fe fe-layers"></i>   <span class="side-menu__label">Upcoming Trips</span>
									</a>
								</li>
								
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i>
										...
										</i>   <span class="side-menu__label">Treks</span> <i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="https://vyz.bz/ridingsolo_admin/all_treks.php" class="slide-item">All Treks	</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/treks_reviews.php" class="slide-item">Reviews</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/transactions.php" class="slide-item">Transaction Details	</a></li>
									</ul>
								</li>

								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i class="fa fa-motorcycle fs-20">
											
										</i>  <span class="side-menu__label">Bike Trips</span> <i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="https://vyz.bz/ridingsolo_admin/all_trips.php" class="slide-item">All Trips	</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/treks_reviews.php" class="slide-item">Reviews</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/transactions.php" class="slide-item">Transaction Details	</a></li>
									</ul>
								</li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i class="icon icon-plane fs-19"></i>   <span class="side-menu__label">Leisure Trips</span> <i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="https://vyz.bz/ridingsolo_admin/all_trips.php" class="slide-item">All Trips	</a></li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i class="icon icon-compass fs-19"></i>   <span class="side-menu__label">Expedition</span> <i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="https://vyz.bz/ridingsolo_admin/all_trips.php" class="slide-item">All Trips	</a></li>
								...
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/enquiries.php">
										<i class="fe fe-headphones fs-19"></i>   <span class="side-menu__label">Enquiries Management</span>
									</a>
								</li>
								
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i class="fe fe-message-square"></i>  <span class="side-menu__label">Campaign Management</span><i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/contacts.php" class="slide-item">Contacts</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/templates.php" class="slide-item">Templates</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/manage_campaign.php" class="slide-item">Manage Campaign</a></li>
									</ul>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/items.php">
										<i class="fe fe-box"></i>   <span class="side-menu__label">Items</span>
									</a>
								</li>
								...
								<li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/#">
										<i class="fe fe-users"></i>  <span class="side-menu__label">Users Management</span><i class="angle fa fa-angle-right"></i>
									</a>
									<ul class="slide-menu">
                                        <li><a href="https://vyz.bz/ridingsolo_admin/admin_users.php" class="slide-item">Admin Users</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/customers.php" class="slide-item">Customers</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/roles.php" class="slide-item">Roles</a></li>
										<li><a href="https://vyz.bz/ridingsolo_admin/privileges.php" class="slide-item">Privileges</a></li>
									</ul>
								</li>
								<!-- <li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="https://vyz.bz/ridingsolo_admin/faqs.php">
										<i class="fe fe-message-circle fs-19"></i>   <span class="side-menu__label">FAQ's</span>
									</a>
								</li>
 ...
 -->
						...
						<div class="main-container container-fluid">
							...
							<div class="page-header">
								...
								<div class="ms-auto pageheader-btn">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="https://vyz.bz/ridingsolo_admin/javascript:void(0);">Home</a></li>
							...
							<div class="row">
								<div class="col-md-12 mb-3">
									<div class="btn-list float-end">
										...
										<a href="https://vyz.bz/ridingsolo_admin/#" class="btn btn-info">
											...
											<div class="table-responsive">
												<table id="data-table" class="table text-nowrap mb-0 table-bordered">
													...
													<tbody class="table-body">
														<tr>
															<td class="text-muted fs-14 fw-semibold text-center">1</td>
															<td class="text-muted fs-14 fw-semibold text-center">Rakesh</td>
															<td class="text-muted fs-14 fw-semibold text-center">Machidi</td>
															<td class="text-muted fs-14 fw-semibold">rakesh.m@siriinnovations.com</td>
															<td class="text-muted fs-14 fw-semibold text-center">20 February 2020</td>
															...
															<td class=" text-center">
																	<a class="btn btn-sm btn-outline-primary border me-2" data-bs-toggle="tooltip" data-bs-original-title="Reset password">
														...
														<tr>
															<td class="text-muted fs-14 fw-semibold text-center">2</td>
															<td class="text-muted fs-14 fw-semibold text-center">Rakesh</td>
															<td class="text-muted fs-14 fw-semibold text-center">Machidi</td>
															<td class="text-muted fs-14 fw-semibold">rakesh.m@siriinnovations.com</td>
															<td class="text-muted fs-14 fw-semibold text-center">20 February 2020</td>
														...
														<tr>
															<td class="text-muted fs-14 fw-semibold text-center">3</td>
															<td class="text-muted fs-14 fw-semibold text-center">Rakesh</td>
															<td class="text-muted fs-14 fw-semibold text-center">Machidi</td>
															<td class="text-muted fs-14 fw-semibold">rakesh.m@siriinnovations.com</td>
															<td class="text-muted fs-14 fw-semibold text-center">20 February 2020</td>
														...
														<tr>
															<td class="text-muted fs-14 fw-semibold text-center">4</td>
															<td class="text-muted fs-14 fw-semibold text-center">Rakesh</td>
															<td class="text-muted fs-14 fw-semibold text-center">Machidi</td>
															<td class="text-muted fs-14 fw-semibold">rakesh.m@siriinnovations.com</td>
															<td class="text-muted fs-14 fw-semibold text-center">20 February 2020</td>
				...
				<div class="container">
					<div class="row align-items-center flex-row-reverse">
						<div class="col-md-12 col-sm-12 text-center">
							Copyright © 2022 <a href="https://vyz.bz/ridingsolo_admin/#">Ridingsolo</a> All rights reserved
						</div>
					</div>
				</div>
			</footer>
        ...
        <!-- SIDE-MENU JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/sidemenu/sidemenu.js"></script>
		
		<!-- Perfect SCROLLBAR JS-->
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/p-scroll/perfect-scrollbar.js"></script>
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/p-scroll/pscroll.js"></script>
		
		<!-- STICKY JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/sticky.js"></script>
				
		<!-- APEXCHART JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/apexcharts.js"></script>
		
		<!-- INTERNAL SELECT2 JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/select2/select2.full.min.js"></script>
		
		<!-- CHART-CIRCLE JS-->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/circle-progress.min.js"></script>
		
		<!-- INTERNAL DATA-TABLES JS-->
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
		<script src="https://vyz.bz/ridingsolo_admin/assets/plugins/datatable/dataTables.responsive.min.js"></script>

		<!-- INDEX JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/index1.js"></script>
		
		<!-- REPLY JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/reply.js"></script>

		
		<!-- COLOR THEME JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/themeColors.js"></script>
		
		<!-- CUSTOM JS -->
		<script src="https://vyz.bz/ridingsolo_admin/assets/js/custom.js"></script>
